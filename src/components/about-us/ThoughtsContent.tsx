...
const sections = [
    ...
    content: (
        <>
        <span>比翼の鳥とは伝説上の鳥で、地上ではそれぞれに歩くけれど、
    ...
    content: (
        <>
        <span>
            ただそういった人であっても、スマートフォンやPCは持っていたりする今の時代、「Wi-fi環境さえあれば学べる」という環境を創ることさえできれば貧困層でも学ぶことができ、またそれによって貧困から抜け出すことができるかもしれないー</span>
        </>
    ),
    },
    {
    content: (
        <>
        <span>
            自社内だけにとどまらず、他の企業とも協力し合いながら、そういった好循環を巻き起こし、社会貢献をしていきたいと考えています。</span>
        </>
    ),
    },
];
