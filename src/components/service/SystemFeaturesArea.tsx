...
export function SystemFeaturesArea () {
    ...
    const data = [
        {
            label: "01",
            src: "/service/systemFeaturesArea/image01.svg",
        ...
        {
            label: "02",
            src: "/service/systemFeaturesArea/image02.svg",
