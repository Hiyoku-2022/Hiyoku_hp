    ...
    return (
        ...
        `}>
            <div className={`
                ...
                w-[80%] space-y-5 xl:space-y-0
                text-white text-center
            `}>
                <div className="md:w-[50%] text-center">
                    <p className="font-Family_2 text-5xl md:text-6xl tracking-widest">Re-Light LMS</p>
                </div>
                <div className="xl:w-[50%] text-center xl:text-start leading-relaxed">
                    ...
                    <div className="leading-relaxed font-semibold">
                        ...
                        <p className="mb-5 xl:mb-0">それから現在まで様々なクライアント様にご好評頂いております。</p>
                        <p className="mb-5 xl:mb-0">私たちHiyokuは現場の多忙な教育担当者の業務のリソースを割かず、”本物のエンジニアを育てる”ことに特化した実績のあるLMSです。</p>
                        <p>ぜひ御社の人材教育に<span className="xl:hidden"><br /></span>Re-Lightをご活用ください!</p>
                    </div>
                </div>
            </div>
        </div>
