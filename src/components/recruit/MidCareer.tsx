...
const midCareerList: MidCareerItem[] = [
    { id: 1, column: '応募資格', detail: 'ITエンジニアとして1年以上の実務経験をお持ちの方\n（職種は問いません）' },
    { id: 2, column: '職種・\n仕事内容', detail: 'ITエンジニア\n（開発・インフラ・プロジェクトマネジメントなど、あなたのスキルや希望に応じて柔軟にアサインします）\n当社の主力である自社ラーニングシステムの開発にも、積極的に携わることができます。' },
    ...
    { id: 8, column: '待遇・\n福利厚生', detail: '社会保険完備、交通費支給、資格取得支援、書籍購入補助' },
...
export default function MidCareer() {
    return (
        <div className="border w-full">
            <h1 className="text-center my-16 font-bold text-xl lg:text-2xl mx-8 md:mx-auto">
                ITエンジニア経験者の方
            </h1>
            <div className='text-center my-4 mx-8 lg:mx-auto'>
                <p className='font-bold text-lg lg:text-xl my-4 lg:mx-auto'>さらなる高みへ！Hiyokuであなたのスキルをアップデートしませんか？</p>
                <p className='text-sm lg:text-base '>
                これまでの経験を活かし、さらなるスキルアップを目指したい方、大歓迎です。
                <br/>新しい環境で知識を深め、リスキリングにも挑戦しながら、
                <br/>あなたのキャリアを次のステージへと進めましょう！
                </p>
            </div>
                    ...
                    <tbody className="border-t">
                        {midCareerList.map((item) => (
                            <tr key={item.id} className="h-20 border-b">
                                <th className="font-thin text-base w-24 md:w-32 lg:w-64 px-auto md:px-4 text-sm lg:text-base whitespace-pre-line">
                                    {item.column}
                                </th>
                                <td className="py-4 px-none md:px-4 whitespace-pre-line text-xs lg:text-base">
                                    {item.detail}
                                </td>
                            </tr>
                        ))}
