                ...
                {faqList.map((item) => (
                    <ul key={item.id} className="w-[90%] md:w-[70%] mx-auto my-2 text-left bg-white rounded-lg p-2">
                        <li className="flex items-center">
                            ...
                            <p className="my-auto text-sub03 font-bold text-sm lg:text-base mx-4">{item.question}</p>
                        </li>
                        <li className="flex items-center">
                            ...
                            <p className="my-auto font-bold text-sm lg:text-base mx-4 whitespace-pre-line">{item.answer}</p>
                        </li>
                    </ul>
                ))}
            </div>
