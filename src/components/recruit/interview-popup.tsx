...
// const popuplist : PopupType[] = [
//     {id:1,
//      name:'Nさん',
//      join:'2024年採用',
//      occupation:'エンジニア',
//      discription:'福岡県出身。テキスト入るテキスト入るテキスト入る',
//      kikkake:'入社のきっかけテキスト入るテキスト入るテキスト入るテキスト入る',
//      workmiryoku:'仕事の魅力テキスト入るテキスト入るテキスト入る',
//      companymiryoku:'ひよくの魅力テキスト入るテキスト入るテキスト入る',
//      target:'今後の目標テキスト入るテキスト入るテキスト入る'},
...
// const InterviewPopup: React.FC<InterviewPopupProps> = ({detail}) => {
//     return (
      /*  <div
        ...
        >
            ...
            <div
            className="relative bg-white rounded-lg shadow-xl max-w-lg w-full p-6 transform transition-all duration-300 sm:my-8 sm:align-middle"
...
//             <div key={detail.id} className="bg-white w-200 h-200">
//                 <span className="text-rigth">×</span>
//                 <div className="flex">
//                     <Image src="/recruit/responsive.png" alt="popup" width={10} height={10} />
//                     <p>{detail.name}</p>
//                     <p>{detail.join}</p>
//                 </div>
//                 <div className="flex">
...
//                 <div>
//                     <p>仕事の魅力</p>
//                     <p>{detail.workmiryoku}</p>
//                 </div>
//                 <div>
//                     <p>Hiyokuの魅力</p>
//                     <p>{detail.companymiryoku}</p>
//                 </div>
//                 <div>
//                     <p>今後の目標</p>
//                     <p>{detail.target}</p>
