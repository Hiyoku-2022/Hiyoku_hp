...
const graduateList: GraduateItem[] = [
    { id: 1, column: '応募資格', detail: 'テキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入ります' },
    { id: 2, column: '職種・仕事内容', detail: 'エンジニア' },
    { id: 3, column: '雇用形態', detail: '正社員' },
    { id: 4, column: '求める人物像', detail: 'テキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入ります' },
    { id: 5, column: '試用期間', detail: '6ヶ月' },
    { id: 6, column: '給与', detail: '180,000〜' },
    { id: 7, column: '勤務地', detail: '博多、天神、赤坂…etc' },
    { id: 8, column: '待遇・福利厚生', detail: 'テキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入りますテキスト入ります' },
