...
<div className="border w-full">
    <h1 className="text-center mt-10 text-2xl text-bold">中途採用</h1>
    <div className="mx-auto py-10 px-20">
    <table className="text-left mx-auto w-full">
    <tbody className="border-t">
        {migCareerList.map((migCareerList)=>( 
            <tr key={migCareerList.id} className="h-20 border-b">
            <th>{migCareerList.colomun}</th>
            <td>{migCareerList.detail}</td>
            </tr>
        ))}
    </tbody>
    </table>
